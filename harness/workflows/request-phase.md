...
**问题必须是开放性问题**，不是 Yes/No 问题。

**primitive 类型必须覆盖的问题层次**：

| 层次 | 问题类型 | 示例 |
|------|----------|------|
| 1. 定义层 | 是什么/管什么/不管什么 | 「这个协议解决什么问题？不解决什么？」 |
| 2. 范围/边界层 | 能力范围与边界 | 「协议的适用范围在哪里？与相邻协议的边界？」 |
| 3. 机制层 | 核心机制如何工作 | 「核心组件有哪些？关键流程如何流转？」 |
| 4. 关系层 | 与相邻对象的关系 | 「与 X 协议是替代/互补/演进关系？」 |
